...
showSettingsBottomSheet() => showAppBottomSheet(const ProjectDetailBottomSheet());

showAppBottomSheet(Widget widget, {bool isScrollControlled = false, bool popAndShow = false, double? height}) {
  if (popAndShow) Get.back();
  return Get.bottomSheet(height == null ? widget : SizedBox(height: height, child: widget),
